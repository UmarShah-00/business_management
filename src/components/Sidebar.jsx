...
function Sidebar({ setUserRole, userRole }) {
    ...
    return (
        <aside id="top-bar-sidebar" className="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
                <a href="/dashboard" className="flex items-center ps-2.5 mb-5">
                    <img src="/123.png" className="h-6 me-3" alt="/123.png" />
                    <span className="self-center text-lg text-heading font-semibold whitespace-nowrap">Business Management</span>
                </a>
                <ul className="space-y-2 font-medium">
                    <li>
                        <Link to={"/dashboard"} href="#" className="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
                    ...
                    {userRole === 'admin' && (
                        <li>
                            <Link to="/admin-user" className="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
                    ...
                    <li>
                        <a href="#" onClick={handleSignOut} className="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
